...
export default function EditProfile({isEditProfileOpen,setIsEditProfileOpen }:EditProfileProps) {
  return (
    <>
        <div className={`transition duration-200  w-screen h-screen absolute -top-10  bg-[rgba(0,0,0,0.3)]  ${isEditProfileOpen ? 'translate-y-0 -left-0' : 'translate-y-full -left-196'} `} onClick={()=>setIsEditProfileOpen(false)}>
            ...
            <form action="" className='space-y-4 pr-5'>
                <Input placeholder='First name' className='w-full h-12 text-sm' />
                <Input placeholder='Last name' className='w-full h-12 text-sm' />
